<template>
  <div>
    ...
    <div class="tw-flex">
      ...
      <div class="tw-w-9/12 tw-p-4">
        <div class="tw-border tw-rounded-lg tw-shadow-lg">
          <WalletGraph />
          <div class="tw-flex">
           <div class="tw-w-1/2 tw-p-4">
             <h1 class="tw-font-semibold tw-text-lg tw-mb-2">Son İşlemler</h1>
             <RecentActivity />
           </div>
            <div class="tw-w-1/2 tw-p-4">
              <h1 class="tw-font-semibold tw-text-lg tw-mb-2">Bot Geçmişi</h1>
              <RecentBots />
            </div>
          </div>
        </div>
...
import RecentBots from "../../components/wallet/RecentBots";

export default Vue.extend({
  name: "index",
  components: {RecentActivity, WalletStatus, WalletGraph, RecentBots}
})
</script>
